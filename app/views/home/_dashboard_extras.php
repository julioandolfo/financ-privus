...
<script>window.__INSIGHTS_CONFIGURADO = <?= $insightsConfigurado ? 'true' : 'false' ?>;</script>
...
<?php else: ?>
<!-- Card de configuração quando IA não está ativa -->
<div class="mb-8">
    <div class="bg-gray-100 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center gap-4">
            ...
            <div class="flex-1">
                <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100">Insights diários com IA</h3>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    <?php if (!$insightsConfigurado): ?>
                    Para exibir análises inteligentes no dashboard, configure a <strong>chave da API OpenAI</strong> em Configurações.
                    <?php elseif (!$insightsHabilitado): ?>
                    Os insights com IA estão desabilitados. Habilite em Configurações → API e IA.
                    <?php endif; ?>
                </p>
                <a href="/configuracoes?aba=api" class="inline-flex items-center gap-2 mt-3 px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white text-sm font-medium rounded-lg transition-colors">
                    ...
                    Ir para Configurações → API e IA
                </a>
            </div>
        </div>
    </div>
