        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                        <div class="bg-gradient-to-r from-blue-500 to-indigo-600 h-3 rounded-full" style="width: <?= $totais['fornecedores'] > 0 ? ($fornecedores['pf'] / $totais['fornecedores'] * 100) : 0 ?>%"></div>
                    </div>
                </div>
                <div>
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                        <div class="bg-gradient-to-r from-purple-500 to-pink-600 h-3 rounded-full" style="width: <?= $totais['fornecedores'] > 0 ? ($fornecedores['pj'] / $totais['fornecedores'] * 100) : 0 ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                        <div class="bg-gradient-to-r from-cyan-500 to-blue-600 h-3 rounded-full" style="width: <?= $totais['clientes'] > 0 ? ($clientes['pf'] / $totais['clientes'] * 100) : 0 ?>%"></div>
                    </div>
                </div>
                <div>
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                        <div class="bg-gradient-to-r from-violet-500 to-purple-600 h-3 rounded-full" style="width: <?= $totais['clientes'] > 0 ? ($clientes['pj'] / $totais['clientes'] * 100) : 0 ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                        <div class="bg-gradient-to-r from-green-500 to-emerald-600 h-3 rounded-full" style="width: <?= $totais['categorias'] > 0 ? ($categorias['receita'] / $totais['categorias'] * 100) : 0 ?>%"></div>
                    </div>
                </div>
                <div>
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                        <div class="bg-gradient-to-r from-red-500 to-rose-600 h-3 rounded-full" style="width: <?= $totais['categorias'] > 0 ? ($categorias['despesa'] / $totais['categorias'] * 100) : 0 ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
