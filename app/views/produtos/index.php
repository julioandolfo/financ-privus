<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-6 mb-6">
        <form method="GET" action="<?= $this->baseUrl('/produtos') ?>" class="grid grid-cols-1 md:grid-cols-7 gap-4">
            <div>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Custo</label>
                <select name="custo_status" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                    <option value="">Todos</option>
                    <option value="sem_custo" <?= (($filters['custo_status'] ?? '') === 'sem_custo') ? 'selected' : '' ?>>Sem Custo Cadastrado</option>
                    <option value="com_custo" <?= (($filters['custo_status'] ?? '') === 'com_custo') ? 'selected' : '' ?>>Com Custo Cadastrado</option>
                </select>
            </div>
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <?php for ($i = $inicio; $i <= $fim; $i++): ?>
                                <?php if ($i == $paginacao['pagina_atual']): ?>
                                    <span class="px-4 py-2 text-sm bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-medium">
                                        <?= $i ?>
                                    </span>
                                <?php else: ?>
