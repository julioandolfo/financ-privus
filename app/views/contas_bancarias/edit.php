<?php
$isCarteira = ($this->session->get('old')['banco_codigo'] ?? $contaBancaria['banco_codigo']) === '000';
?>
        ...
        <div class="mb-8">
            ...
            <div id="info-carteira" class="hidden mt-3 p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-xl">
                <p class="text-sm text-amber-800 dark:text-amber-300">
                    <strong>Carteira</strong> representa dinheiro em espécie ou caixa físico. Os campos bancários são preenchidos automaticamente.
                </p>
            </div>
        </div>
