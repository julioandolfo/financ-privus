    ...
    [
        ...
        'submenu' => [
            [
                ...
                'path' => '/boletos',
                'active' => $isActive('/boletos') && !$isActive('/boletos/analytics') && !$isActive('/boletos/create')
            ],
            [
                'title' => 'Emitir Boleto',
                'path' => '/boletos/create',
                'active' => $isActive('/boletos/create')
            ],
            [
                'title' => 'Analytics',
                'path' => '/boletos/analytics',
                'active' => $isActive('/boletos/analytics')
            ],
        ]
    ],
    [
