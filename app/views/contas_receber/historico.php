...
function formatarAcao($acao) {
    $acoes = [
        ...
        'cancel_receipt' => ['texto' => 'Cancelamento de Recebimento', 'cor' => 'orange', 'icone' => 'M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6'],
        'make_receipt' => ['texto' => 'Recebimento Realizado', 'cor' => 'green', 'icone' => 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'],
    ...
    <div class="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl shadow-xl p-8 mb-8">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-purple-100">Conta a Receber #<?= $conta['id'] ?> - <?= htmlspecialchars($conta['descricao']) ?></p>
            </div>
            <div class="flex items-center space-x-3">
                <a href="/contas-receber/<?= $conta['id'] ?>" class="bg-white text-purple-600 px-6 py-3 rounded-xl font-semibold hover:bg-purple-50 transition-all shadow-lg flex items-center space-x-2">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-6 mb-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-gray-900 dark:text-gray-100"><?= htmlspecialchars($conta['cliente_nome'] ?? 'N/A') ?></p>
            </div>
            <div>
