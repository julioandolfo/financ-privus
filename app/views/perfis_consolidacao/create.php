...
<div class="flex items-center justify-between mb-8">
    <div>
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">
            Novo Perfil de Consolidação
        </h1>
        <p class="text-gray-600 dark:text-gray-400">
            Crie um perfil para consolidar dados de múltiplas empresas
        </p>
    </div>
</div>
...
<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
    <form action="<?= $this->baseUrl('/perfis-consolidacao') ?>" method="POST" class="p-8">
        <!-- Nome do Perfil -->
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            ><?= htmlspecialchars($this->session->get('old')['descricao'] ?? '') ?></textarea>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="space-y-2 max-h-80 overflow-y-auto bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-200 dark:border-gray-600">
                <?php 
                $oldEmpresas = $this->session->get('old')['empresas_ids'] ?? [];
        ...
        <div class="mb-6">
            <label class="flex items-center cursor-pointer">
                <input 
                    ...
                    name="ativo" 
                    value="1"
                    <?= ($this->session->get('old')['ativo'] ?? '1') == '1' ? 'checked' : '' ?>
