...
<div class="max-w-5xl mx-auto animate-fade-in">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-red-600 to-rose-600 px-8 py-6">
            <h1 class="text-3xl font-bold text-white">Nova Conta a Pagar</h1>
            <p class="text-red-100 mt-2">Cadastre uma nova despesa/pagamento</p>
        </div>

        <!-- Form -->
        <form method="POST" action="/contas-pagar" class="p-8" x-data="contaPagarForm()">
            <!-- Dados Básicos -->
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="fornecedor_id" id="fornecedor_id" data-placeholder="Selecione uma empresa primeiro..."
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-6 mt-3">
                            <label class="flex items-center space-x-2 cursor-pointer">
                                <input type="radio" name="tipo_custo" value="variavel" <?= ($old['tipo_custo'] ?? 'fixo') == 'variavel' ? 'checked' : '' ?>
                                       class="w-5 h-5 text-blue-600 focus:ring-2 focus:ring-blue-500">
                                <span class="text-gray-700 dark:text-gray-300">Variável</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer">
                                <input type="radio" name="tipo_custo" value="fixo" <?= ($old['tipo_custo'] ?? 'fixo') == 'fixo' ? 'checked' : '' ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="descricao" rows="3" required
                                  ...
                                  placeholder="Descreva a despesa..."><?= htmlspecialchars($old['descricao'] ?? '') ?></textarea>
    ...
    return {
        ...
        async carregarCategoriasECentros(empresaId) {
            ...
            try {
                ...
                refreshSelectSearch('fornecedor_id', options);
            } catch (error) {
