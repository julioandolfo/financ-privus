...
<!-- Modal de Baixa -->
<div x-show="showBaixaModal" x-transition.opacity class="fixed inset-0 z-50 flex items-center justify-center px-4">
    <div class="absolute inset-0 bg-black/50" @click="showBaixaModal = false"></div>
    <div class="relative w-full max-w-3xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <form method="POST" action="/contas-pagar/<?= $conta['id'] ?>/baixar" class="p-8 space-y-6">
            ...
            <div class="flex items-center justify-end space-x-4 pt-2">
                <button type="button" @click="showBaixaModal = false" class="px-6 py-3 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors font-medium">
                    Cancelar
                </button>
