        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3">
                <?php if ($conta['status'] != 'pago' && $conta['status'] != 'cancelado'): ?>
                    <a href="/contas-pagar/<?= $conta['id'] ?>/baixar" class="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-xl font-semibold transition-all shadow-lg flex items-center space-x-2">
