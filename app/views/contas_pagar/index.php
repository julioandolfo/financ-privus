    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden"
        ...
        <div x-show="showDeleteModal" x-cloak
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 max-w-md w-full">
                ...
                <form method="POST" action="/contas-pagar/deletar-massa">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2 mb-2">
                                <label class="flex-1 flex items-center gap-2 cursor-pointer p-2.5 rounded-lg border transition-colors"
                                       :class="tipoBaixaData === 'manual' ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700'">
                                    <input type="radio" x-model="tipoBaixaData" value="manual" class="text-red-600 focus:ring-red-500">
                                    <span class="text-sm text-gray-700 dark:text-gray-300">Data manual</span>
                                </label>
                                <label class="flex-1 flex items-center gap-2 cursor-pointer p-2.5 rounded-lg border transition-colors"
                                       :class="tipoBaixaData === 'vencimento' ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700'">
                                    <input type="radio" x-model="tipoBaixaData" value="vencimento" class="text-red-600 focus:ring-red-500">
                                    <span class="text-sm text-gray-700 dark:text-gray-300">Data de vencimento</span>
                                </label>
                            </div>
                            <div x-show="tipoBaixaData === 'manual'" x-transition>
                                <input type="date" name="data_pagamento" :required="tipoBaixaData === 'manual'" value="<?= date('Y-m-d') ?>"
                                       class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                            </div>
                            <div x-show="tipoBaixaData === 'vencimento'" x-transition>
                                <p class="text-sm text-gray-500 dark:text-gray-400 italic px-1">Cada conta será paga na sua própria data de vencimento.</p>
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Forma de Pagamento</label>
