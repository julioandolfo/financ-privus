...
<div class="max-w-7xl mx-auto animate-fade-in">
    ...
    <div class="bg-gradient-to-r from-gray-700 to-gray-900 rounded-2xl shadow-xl p-8 mb-8">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-white mb-2">🗑️ Registros Deletados - Contas a Pagar</h1>
                <p class="text-gray-300">Contas excluídas que podem ser restauradas</p>
            </div>
            <a href="/contas-pagar" class="bg-white text-gray-900 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-all shadow-lg flex items-center space-x-2">
                ...
                <table class="w-full">
                    <thead class="bg-gray-50 dark:bg-gray-900/50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Fornecedor</th>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 dark:text-gray-100">
                                        <?= htmlspecialchars($conta['fornecedor_nome'] ?? 'N/A') ?>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center space-x-2">
                                        <a href="/contas-pagar/<?= $conta['id'] ?>/historico" 
                                        ...
                                        <form method="POST" action="/contas-pagar/<?= $conta['id'] ?>/restore" 
                                              class="inline"
