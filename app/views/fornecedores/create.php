<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
        <form method="POST" action="<?= baseUrl('/fornecedores') ?>" class="space-y-6">
            <!-- Empresa -->
            <div>
                ...
                <select id="empresa_id" 
                    ...
                    <?php foreach ($empresas as $empresa): ?>
                        <option value="<?= $empresa['id'] ?>" <?= (($session->get('old')['empresa_id'] ?? '') == $empresa['id']) ? 'selected' : '' ?>>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <label class="flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all <?= ($session->get('old')['tipo'] ?? '') === 'fisica' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-700' ?>">
                        <input type="radio" 
                               name="tipo" 
                               value="fisica" 
                               <?= ($session->get('old')['tipo'] ?? '') === 'fisica' ? 'checked' : '' ?>
                    ...
                    <label class="flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all <?= ($session->get('old')['tipo'] ?? '') === 'juridica' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-700' ?>">
                        <input type="radio" 
                               name="tipo" 
                               value="juridica" 
                               <?= ($session->get('old')['tipo'] ?? '') === 'juridica' ? 'checked' : '' ?>
                               class="w-5 h-5 text-blue-600 focus:ring-blue-500" 
                               required>
                        <div class="ml-3">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       value="<?= htmlspecialchars($session->get('old')['nome_razao_social'] ?? '') ?>"
                       minlength="3"
                       maxlength="255"
            ...
            <div>
                ...
                <input type="text" 
                       id="cpf_cnpj" 
                       name="cpf_cnpj" 
                       value="<?= htmlspecialchars($session->get('old')['cpf_cnpj'] ?? '') ?>"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" 
                               ...
                               name="endereco[cep]" 
                               data-mask="cep"
                               value="<?= htmlspecialchars($session->get('old')['endereco']['cep'] ?? '') ?>"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" 
                               ...
                               value="<?= htmlspecialchars($session->get('old')['endereco']['logradouro'] ?? '') ?>"
                               class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mt-4">
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="<?= htmlspecialchars($session->get('old')['endereco']['numero'] ?? '') ?>"
                               class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <input type="text" 
                               ...
                               value="<?= htmlspecialchars($session->get('old')['endereco']['complemento'] ?? '') ?>"
                               class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                    </div>
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="<?= htmlspecialchars($session->get('old')['endereco']['bairro'] ?? '') ?>"
                               class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="<?= htmlspecialchars($session->get('old')['endereco']['cidade'] ?? '') ?>"
                               class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                    </div>
                    <div>
                        ...
                        <select id="estado" 
                            ...
                            $estadoAtual = $session->get('old')['endereco']['estado'] ?? '';
