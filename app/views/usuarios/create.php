<div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
            <form method="POST" action="<?= baseUrl('/usuarios/store') ?>" class="space-y-6">
                <!-- Nome -->
                <div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" 
                                ...
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300"
                                title="Mostrar/Ocultar senha">
                            <svg id="icon-senha_confirm-eye" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                            </svg>
                            <svg id="icon-senha_confirm-eye-off" class="w-5 h-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.487 5.197m0 0L21 21" />
                            </svg>
                        </button>
                    </div>
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Digite a mesma senha novamente</p>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (senha && senhaConfirm) {
        function validatePasswordMatch() {
            if (senhaConfirm.value && senha.value !== senhaConfirm.value) {
                senhaConfirm.setCustomValidity('As senhas não coincidem');
                senhaConfirm.classList.add('border-red-500');
            } else {
                senhaConfirm.setCustomValidity('');
                senhaConfirm.classList.remove('border-red-500');
            }
        }
