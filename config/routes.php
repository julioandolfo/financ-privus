...
return [
    ...
    // Rotas estáticas e específicas primeiro, depois as com parâmetros dinâmicos
    ...
    'POST /pedidos/alterar-status-massa' => ['handler' => 'PedidoVinculadoController@alterarStatusMassa', 'middleware' => ['AuthMiddleware']],
    ...
    'POST /contas-pagar/atualizar-data-massa' => ['handler' => 'ContaPagarController@atualizarDataMassa', 'middleware' => ['AuthMiddleware']],
    'POST /contas-pagar/deletar-massa' => ['handler' => 'ContaPagarController@deletarMassa', 'middleware' => ['AuthMiddleware']],
    ...
    'POST /contas-receber/atualizar-data-massa' => ['handler' => 'ContaReceberController@atualizarDataMassa', 'middleware' => ['AuthMiddleware']],
    'POST /contas-receber/deletar-massa' => ['handler' => 'ContaReceberController@deletarMassa', 'middleware' => ['AuthMiddleware']],
    ...
    'PATCH /api/v1/pedidos' => ['handler' => 'ApiRestController@pedidosBatchUpdate', 'middleware' => ['ApiAuthMiddleware']],
    'PATCH /api/v1/pedidos/{id}' => ['handler' => 'ApiRestController@pedidosUpdateFrete', 'middleware' => ['ApiAuthMiddleware']],
